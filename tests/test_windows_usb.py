...
class WindowsUsbCopy(unittest.TestCase):
    ...
    def test_optional_prepared_page_copied_beside_bot(self):
        page = self.base / 'Prepared reference.html'
        page.write_bytes(b'<!doctype html><title>SYNTHETIC prepared reference</title>\r\n')
    ...
    @unittest.skipIf(os.name == 'nt', 'reference.html is generated by the Linux runtime; Windows CI copies a prepared page')
